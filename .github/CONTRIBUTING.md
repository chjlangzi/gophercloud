...
[here](https://github.com/chjlangzi/gophercloud/tree/master/docs/contributor-tutorial)!
...
[bug tracker](https://github.com/chjlangzi/gophercloud/issues) and finding open
...
and can be read online at [godoc.org](https://godoc.org/github.com/chjlangzi/gophercloud).
...
get dependencies for unit and acceptance tests.
   ...
   ```bash
   go get -tags "fixtures acceptance" github.com/chjlangzi/gophercloud
   ```

2. Move into the directory that houses your local repository:

   ```bash
   cd ${GOPATH}/src/github.com/chjlangzi/gophercloud
   ```

3. Fork the `chjlangzi/gophercloud` repository and update your remote refs. You
...
7. Submit your branch as a [Pull Request](https://help.github.com/articles/creating-a-pull-request/). When submitting a Pull Request, please follow our [Style Guide](https://github.com/chjlangzi/gophercloud/blob/master/docs/STYLEGUIDE.md).
